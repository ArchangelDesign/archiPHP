...
class ArchiRequestMethod
{
    ...
    {
        return in_array($method, $this->cacheableMethods) || in_array($method, $this->notCacheableMethods);
    }

    public function isCacheable(): bool
    {
        return in_array($this->method, $this->cacheableMethods);
    }
